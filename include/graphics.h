...
namespace Graphics
{
	...
	void SetPixel(unsigned int *buffer, int bw, int bh, int x, int y, unsigned int color);
	...
	void DrawBuffer(unsigned int *dest, unsigned int *buffer, int bw, int bh, int x, int y, int w, int h);
