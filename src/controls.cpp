...
{
	struct Button *btn = (struct Button *)button;
	Graphics::FillRect(buffer, bw, bh, btn->x + 4, btn->y + 24, btn->w, btn->h, 0xb0a090);
	Graphics::HorizontalLine(buffer, bw, bh, btn->x + 4, btn->y + 24, btn->w, 0xf0c0b0);
	Graphics::VerticalLine(buffer, bw, bh, btn->x + 4, btn->y + 24, btn->h, 0xf0c0b0);
	Graphics::HorizontalLine(buffer, bw, bh, btn->x + 4, btn->y + btn->h + 24, btn->w, 0x907060);
	Graphics::VerticalLine(buffer, bw, bh, btn->x + btn->w + 4, btn->y + 24, btn->h, 0x907060);
